// Copied from https://github.com/oyvindberg/tui-scala/blob/9f6b67db089ac10a183fe9f992a6bc81df125bc9/crossterm/src/java/tui/crossterm/NativeLoader.java
...
class NativeLoader {
    ...
    private static String getPlatform() {
        if (System.getenv().containsKey("TOKENIZERS_SCALA_PLATFORM")) {
            return System.getenv().get("TOKZENIZERS_SCALA_PLATFORM");
        }
